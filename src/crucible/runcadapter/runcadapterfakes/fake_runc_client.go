...
func (fake *FakeRuncClient) RunContainer(pidFilePath string, bundlePath string, containerID string, stdout io.Writer, stderr io.Writer) error {
...
func (fake *FakeRuncClient) RunContainerArgsForCall(i int) (string, string, string, io.Writer, io.Writer) {
	fake.runContainerMutex.RLock()
	defer fake.runContainerMutex.RUnlock()
...
func (fake *FakeRuncClient) RunContainerReturns(result1 error) {
...
func (fake *FakeRuncClient) RunContainerReturnsOnCall(i int, result1 error) {
	fake.RunContainerStub = nil
...
func (fake *FakeRuncClient) ListContainers() ([]runcadapter.ContainerState, error) {
...
func (fake *FakeRuncClient) ListContainersReturns(result1 []runcadapter.ContainerState, result2 error) {
...
func (fake *FakeRuncClient) ListContainersReturnsOnCall(i int, result1 []runcadapter.ContainerState, result2 error) {
	fake.ListContainersStub = nil
...
var _ runcadapter.RuncClient = new(FakeRuncClient)
